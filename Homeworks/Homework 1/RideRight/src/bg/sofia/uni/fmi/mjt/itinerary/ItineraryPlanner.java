...
public interface ItineraryPlanner {
    ...
    /**
     * Returns a sequenced collection of Journeys representing
     * the cheapest path from the start to the destination City.
     *
     * @param start         - City, from which the itinerary begins
     * @param destination   - the City that needs to be reached
     * @param allowTransfer - a flag parameter whether multiple Journeys
     * with transfer can be returned as a result, or
     ...
     */
    SequencedCollection<Journey> findCheapestPath(
            City start,
            City destination,
